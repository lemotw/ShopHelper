...
-->
        <div id="sidebar-wrapper">
            <ul class="sidebar-nav" id="side-menu">
                ...
                <li>
                    <a href="{{ route('sale.TodaySaleReport', ['Shop'=>$ShopId]) }}"><i class="fas fa-fw fa-file-invoice-dollar li-icon"></i>營業簡報</a>
                </li>
                <li>
                    <a href="{{ route('sale.TodaySale', ['Shop'=>$ShopId]) }}"><i class="fas fa-fw fa-chart-line li-icon"></i>商品銷售統計</a>
                </li>
                <li>
                    <a href="{{ route('sale.TodaySaleStatistic', ['Shop'=>$ShopId]) }}"><i class="fas fa-fw fa-chart-pie li-icon"></i>銷售明細查詢</a>
                </li>
                <li>
                    <a href="{{ route('sale.TodaySaleInvoice', ['Shop'=>$ShopId]) }}"><i class="fas fa-fw fa-file-invoice li-icon"></i>發票明細查詢</a>
                </li>
                <li>
                ...
                <li>
                    <a href="{{ route('ShopHolderIndex') }}"><i class="fas fa-fw fa-paper-plane li-icon"></i>離開</a>
                </li>
