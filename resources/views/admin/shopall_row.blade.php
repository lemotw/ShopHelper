                            ...
                            <table class="table table-striped table-hover table-fullcol">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>{{ $shop->id }}</td>
                                        <td>{{ $shop->name }}</td>
                                        <td><a href="{{ route('ShowShopEdit', ['Shop'=>$shop->id,'User'=>$User->id]) }}" class="btn btn-primary">店家資料維護</a></td>
                                        <td>{{ $shop->updated_at }}</td>
                                        <td><a onclick="delete_check('{{ route('ShopDelete', ['Shop'=>$shop->id]) }}')" class="btn btn-danger">刪除</a></td>
                                    </tr>
                                    @endforeach
                                </tbody>
                            </table>
